...
### 公众号少年歌行pro：4月16日8:00，脚本进行如下变动：

 1、新增了 `肥皂`  大佬的 `招招试药`  脚本
 
 2、自己写了一个 `酸奶机场` 每日签到得流量脚本 ，就是我之前群里推荐过的那个
...
### 公众号少年歌行pro：4月12日8:00，脚本进行如下变动：
```
 1、新增了 肥皂  大佬的 萌喵大作战无限刷  脚本
 
 2、新增了 肥皂  大佬的 钢镚赚乐步达人二合一  脚本
...
```properties
 ...
 1、新增了 肥皂 大佬  的  葫芦音乐 脚本 
 
 2、新增了 ztxtop 大佬的 悦趣阅读自动阅读文章 脚本
 ```
...
```properties
 ...
 1、调整了 肥皂大佬 的 西梅 脚本 cookie重写
 
 2、新增了 肥皂大佬 的  最强蜗牛 脚本
 
 3、新增了肥皂大佬  的  睡眠赚无限刷 脚本
 ```
...
###  公众号少年歌行pro：3月30日10:00，脚本进行如下变动：

```properties

 1、修复了 肥皂大佬 的 文创阅读 脚本 无法获取cookie的问题
...
1、增加了i-chenzhe大佬的 京东城城分现金（被助力很难） 脚本

2、增加了i-chenzhe大佬的 京东联想集卡活动 脚本
